...
class CRUNet(nn.Module):
    def __init__(self, selected_dim, in_channels, out_channels, device):
        ...
        self.ca5=CoordAtt(inp=64,oup=64)
        self.ca1=CoordAtt(inp=128,oup=128)
        ...
        self.ca2 = CoordAtt(inp=256, oup=256)
        ...
        self.ca3 = CoordAtt(inp=512, oup=512)
        ...
        self.ca4 = CoordAtt(inp=1024, oup=1024)
    ...
    def forward(self, x, **kwargs):
        ...
        x9 = self.down4(x8)
        ca4 = self.ca4(x9)
        x10 = self.up1(ca4, ca3)
        x11 = self.res5(x10)
        x12 = self.up2(x11, ca2)
        x13 = self.res6(x12)
        x14 = self.up3(x13, ca1)
        x15 = self.res7(x14)
        x16 = self.up4(x15, ca5)
        x17 = self.res8(x16)
        out = self.out(x17)
