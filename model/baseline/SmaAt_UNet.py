...
class SmaAt_UNet(nn.Module):
    def __init__(self, selected_dim,in_channels, out_channels,device ,kernels_per_layer=2, bilinear=True, reduction_ratio=16,
                 ):
...
if __name__ == '__main__':
    ...
    model = SmaAt_UNet(selected_dim=0,in_channels=10, out_channels=10,device='cuda'
                       )
